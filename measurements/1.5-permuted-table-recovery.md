...
|---|---|---|---|---|---|---|---|---|
| yor | 0.2151 | 1356 | 692 | 3 | 120/120 | 200 | 200 | 3153 |
| yue | 0.2062 | 1299 | 648 | 6 | 0/120 | not recovered | - | 3150 |
| cmn | 0.1870 | 1095 | 549 | 4 | 0/120 | not recovered | - | 2929 |
| hin | 0.1245 | 673 | 355 | 3 | 120/120 | 718 | 800 | 2703 |
| czr | 0.1101 | 553 | 269 | 3 | 120/120 | 740 | 800 | 2511 |
| cym | 0.0031 | 13 | 9 | 1 | 0/120 | not recovered | - | 2105 |
| nld | 0.0022 | 9 | 3 | 1 | 10/120 | 800 | 800 | 2091 |
| tgl | 0.0011 | 5 | 2 | 1 | 0/120 | not recovered | - | 2345 |
| lat | 0.0009 | 4 | 3 | 1 | 12/120 | 50 | 50 | 2171 |
| eus | 0.0009 | 4 | 4 | 1 | 0/120 | not recovered | - | 2259 |

Seven languages are excluded because their corpus carries no mark at
all (zul, swa, som, mly, kor, ind, eng). Nothing can be recovered from a table
...
Recovered on every one of the 120 permutations: yor at a mean of 200 characters, hin at a mean of 718 characters, czr at a mean of 740 characters.
That is the section E claim confirmed, at the order of magnitude it
states -- a few hundred characters of a known language.

Never recovered, at any window the corpus allows: yue (6 digits in use, 3150 symbols available), cmn (4 digits in use, 2929 symbols available).
